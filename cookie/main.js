	...
	Game.Init=function()
	{
		...
		Game.WriteSave=function(exporting)//guess what we'e using to save the game?
		{
			...
			else
			{
				...
				//we're using cookies
				//yeah I went there
				var now=new Date();//we storin dis for 67 years, people
				now.setFullYear(now.getFullYear()+67);//mmh stale cookies
		...
		Game.UpdateMenu=function()
		{
			...
			if (Game.onMenu=='log')
			{
				str+='<div class="section">Redundant</div>'+
				'</div><div class="subsection">'+
				'<div class="title">Note :</div>'+
				'<div class="listing">This is to be removed in a later update of the game.</a></div>'
				;
			}
